...
public class SQLQuery extends Query implements BatchRequestParticipant {
    ...
    private void writeOutUpdatedRowCount(Statement stmt, XMLStreamWriter xmlWriter, InternalParamCollection params,
        ...
        //Updated Row Count result is mapped to Column Number 1 in UI
                ...
                if (this.isJDBCBatchRequest()) {
                    ...
                    if (this.isJDBCLastBatchRequest()) {
                        ...
                        if (this.isReturnUpdatedRowCount()) {
                            /* handle updated row count, i.e. SQL UPDATE etc.. */
        ...
        try {
            ...
            if (stmt == null) {
                ...
                if (queryType == SQLQuery.DS_QUERY_TYPE_NORMAL) {
                    ...
                    } else if (this.isReturnUpdatedRowCount()) {
                        stmt = conn.prepareStatement(processedSQL, Statement.RETURN_GENERATED_KEYS); //Not correct way
                    }else{
                        stmt = conn.prepareStatement(processedSQL);
                    }
